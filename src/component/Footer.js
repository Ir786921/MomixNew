        ...
        <div className="tw-flex tw-flex-wrap tw-justify-between">
          ...
          <div className="tw-w-full md:tw-w-1/4 tw-mb-8 md:tw-mb-0">
            <div className="tw-flex tw-items-center tw-mb-4">
              <h2 className="tw-text-red-600 tw-font-bold tw-text-2xl">
                MOMIX
              </h2>
            ...
            <p className="tw-text-gray-400 tw-mb-6">
              ...
              Discover thousands of movies and shows in stunning quality.
            </p>
            <div className="tw-flex tw-space-x-4">
              <a
                href="#"
                className="tw-bg-black tw-p-2 tw-rounded-full tw-border tw-border-red-800 tw-text-red-600 tw-hover:bg-red-900 tw-hover:text-white tw-transition-all"
              >
          ...
          <div className="tw-w-full md:tw-w-1/5 tw-mb-6 md:tw-mb-0">
            ...
            <ul className="tw-space-y-3">
              <li className="tw-list-none tw-transition-all tw-duration-300">
                <Link
                  to="/movie"
                  className="tw-no-underline tw-text-gray-400 tw-hover:text-red-500 tw-flex tw-items-center"
                >
          ...
          <div className="tw-w-full md:tw-w-1/5">
            ...
            <ul className="tw-space-y-3">
              ...
              <li className="tw-list-none tw-transition-all tw-duration-300">
                <a
                  href="https://www.linkedin.com/in/imran-raza-786mn/"
                  className="tw-no-underline tw-text-gray-400 tw-hover:text-red-500 tw-flex tw-items-center"
                >
