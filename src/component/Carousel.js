      ...
      >
        <div className="tw-w-64 tw-rounded-md tw-overflow-hidden tw-shadow-xl tw-bg-black tw-bg-gray-900">
          ...
          <div className="tw-relative" onClick={()=>clickHandler(movie?.ids?.trakt,movie?.media_type)} >
                ...
                <div className="tw-absolute tw-inset-0 tw-bg-gradient-to-t tw-from-black tw-to-transparent tw-opacity-0 hover:tw-opacity-100 tw-transition-opacity tw-flex tw-items-center tw-justify-center">
          ...
          <div className="tw-bg-gray-900 tw-text-white tw-p-3">
            ...
            >
              <span  className="text-lg"> <i class="fa-solid fa-plus tw-text-black tw-text-lg" id={movie?.ids?.tmdb}></i> </span>
            </button>
            </div>
            {/* Genres */}
